...
- 🖋 [最新の勉強ログ(2026.06)](https://github.com/corekaraweb/study-log/blob/main/202606studylog.md)
...
| IT系資格 | Salesforce認定Platformアドミニストレーター<br>Salesforce認定Platformアプリケーションビルダー<br>Salesforce認定Sales Cloudコンサルタント<br>Salesforce認定Agentforce スペシャリスト<br>Java Silver SE17<br>HTML5プロフェッショナル認定試験レベル2<br>認定SEOコンサルタント<br>SEO検定1級<br>ウェブ解析士<br>G検定<br>生成AIパスポート |
| ビジネス系資格 | 日商簿記2級<br>2級ファイナンシャルプランニング技能士<br>AFP<br>健康経営アドバイザー<br>両立支援コーディネーター<br>ビジネス実務法務検定2級<br>メンタルヘルスマネジメント検定Ⅱ種<br>年金アドバイザー3級<br>社会福祉主事任用資格 |
